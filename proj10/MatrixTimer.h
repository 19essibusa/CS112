...
MatrixTimer::MatrixTimer(unsigned numTrials, const string& logFile) {
    ...
    /* Create two new matrices to be used for multiplication method. These are 1024x1024 matrices.
     * This is because the matrices created first are of too large a dimension.
     * This causes the test program to run for too long which makes it a very inefficient way for testing.
     */
