 ...
 * Contents are output in the order that they are accessed
 */
template <class Item>
 ...
 * Contents are output after the items below them are processed
 */
template <class Item>
...
/*
 * Calls itself myRight and myLeft and then outputs myItem
 */
template <class Item>
...
/*
 *Calls itself myLeft then outputs myItem then calls itself on myRight
 */
template <class Item>
